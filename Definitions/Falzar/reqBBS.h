#ifndef DEF_FALZAR_REQBBS_H
#define DEF_FALZAR_REQBBS_H
...
#define reqBBS_813E534 ((int __fastcall (*) (int a1)) (0x0813E534 +1))
...
#define reqBBS_813F8F0 ((int __fastcall (*) (int a1)) (0x0813F8F0 +1))
...
#define reqBBS_813FD14 ((int __noreturn (*) ()) (0x0813FD14 +1))
...
#define reqBBS_anim_814004C ((__int64 __fastcall (*) (int a1, int a2, int a3, int a4)) (0x0814004C +1))
...
#define reqBBS_81403C0 ((int (*) ()) (0x081403C0 +1))
...
#define reqBBS_run_dialog_8140A70 ((void __fastcall (*) (int a1, int a2)) (0x08140A5C +1))
