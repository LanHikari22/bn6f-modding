#ifndef SCRIPT_BATTLEMENU_H
#define SCRIPT_BATTLEMENU_H
...
#define BattleMenu_8026B04 ((int __fastcall (*) (int a1, int a2, int a3)) (0x08026B04+1))
#define BattleMenu_8026BF4 ((int (*) ()) (0x08026BF4+1))
#define BattleMenu_8026DB0 ((int (*) ()) (0x08026DB0+1))
#define BattleMenu_cp_8026E98 ((int (*) ()) (0x08026E98+1))
...
#define BattleMenu_802723A ((unsigned int __fastcall (*) (int a1, int a2, int a3)) (0x0802723A+1))
...
#define BattleMenu_syscall_8027834 ((int __fastcall (*) (int a1, int a2, int a3)) (0x08027834+1))
#define BattleMenu_802790C ((int __fastcall (*) (int a1, int a2, int a3)) (0x0802790C+1))
#define BattleMenu_joystick_802794A ((u32 __fastcall (*) (int a1, int a2, int a3)) (0x0802794A+1))
