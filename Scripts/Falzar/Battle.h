...
#define Battle_801E574 ((int __fastcall (*) (int a1, int a2, int a3, int a4, int a5, int a6, int a7, int (__fastcall *a8)) (0x0801E574 +1))
...
#define BattleMenu_802774C ((int __fastcall (*) (int a1, int a2, int a3, int a4, int (*a5)) (0x0802774C +1))
