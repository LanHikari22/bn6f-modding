...
#define main_80015B4 ((void __fastcall (*) (int a1, int a2, int a3, int a4)) (0x080015B4+1))
#define main_80017EC ((void __fastcall (*) (int a1, int a2, int a3, int a4)) (0x080017EC+1))
