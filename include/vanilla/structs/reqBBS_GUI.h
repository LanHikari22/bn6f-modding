...
0x05    u8    numNewRequests
    This corresponds to the XX in (new = XX/YY)  
0x08    u8    animationTimer0
...
0x0F    u8    ?
    ...
    is played
0x1E    u16   totalNewRequests
    This corresponds to the YY in (new = XX/YY)  
0x20    u16   cursorPos    
0x22    u16   RO_cursorPos    
0x24    u16   pagePos    
0x26    u16   RO_pagePos    
0x28    void  *reqBBS_textualPointers    
