...
typedef struct{
	...
	uint8_t unk_80;     // loc=0x80 CONFLICT u32
		uint8_t pad_81[0x3]; // loc=0x81
	uint32_t unk_84;    // loc=0x84
	uint32_t unk_88;    // loc=0x88
		uint8_t pad_8C[0x4]; // loc=0x8C
	uint32_t unk_90;    // loc=0x90
	uint8_t unk_94;     // loc=0x94
		uint8_t pad_95[0x3]; // loc=0x95
	// size=0x98
}ChatBoxPropreties;
